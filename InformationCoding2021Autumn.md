...
成绩：本课程会有课后作业,课后作业无需提交，教师会按时公布参考答案。本课程会有两次小测验Q1和Q2，分别在第4周和第8周,以及一次期末考试T。
小测验Q1和Q2的题目将会是课后作业的微小变型，认真完成作业并熟悉参考答案的同学将会顺利拿到好成绩。
最终课业成绩的计算方法为：课程成绩 = max{20% * Q1 + 20% * Q2 + 60% * T, T}。
无论因何种原因缺席任意一次小测验Q1或Q2，其课程成绩 = T。
